...
SOURCES = SystemManager SystemManager/config AuthorizationRequestsManager MonitorEngine log utils/string AuthorizationRequest SystemManager/SharedMemory SystemManager/MessageQueue
